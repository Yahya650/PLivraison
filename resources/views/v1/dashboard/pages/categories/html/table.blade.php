                ...
                <td>
                    <div class="d-flex gap-2">
                        ...
                        <a href="#!" class="btn btn-soft-primary btn-sm anchor-modal"
                            ...
                            data-href="{{ route('app.categories.edit', cryptID($category?->id)) }}"
                            data-modal-size="modal-xl"><iconify-icon icon="solar:pen-2-broken"
                                class="align-middle fs-18"></iconify-icon></a>
                        <a href="#!" class="btn btn-soft-danger btn-sm anchor-delete"
                            data-href="{{ route('app.categories.destroy', cryptID($category?->id)) }}"
                            data-container="#categories"><iconify-icon icon="solar:trash-bin-minimalistic-2-broken"
                                class="align-middle fs-18"></iconify-icon></a>
                    </div>
                </td>
            </tr>
