<div class="main-nav">
    ...
    <div class="logo-box">
        <a href="index.html" class="logo-dark">
            <img src="/v1/dash/assets/images/logo-sm.png" class="logo-sm" alt="logo sm">
            <img src="/v1/dash/assets/images/logo-dark.png" class="logo-lg" alt="logo dark">
        </a>

        <a href="index.html" class="logo-light">
            <img src="/v1/dash/assets/images/logo-sm.png" class="logo-sm" alt="logo sm">
            <img src="/v1/dash/assets/images/logo-light.png" class="logo-lg" alt="logo light">
        </a>
    </div>
